  ...
  return (
    <div className="test-container">
      ...
      <div className="component">
        ...
        <ButtonBlack ariaLabel="test-button" className="test-clas-2" rounded={true}>
          Test 123 321
        </ButtonBlack>
      </div>
      ...
      <div className="component">
        <h2 className="component__title">ImageWithBackgroundColor not Active</h2>
      ...
      <div className="component">
        ...
        <RateStars max={5} value={4} inColor="gold" outColor="white"></RateStars>
      </div>
      ...
      <div className="component">
        ...
        >
          <SvgFacebook width={6} height={12} className="class-test-3"></SvgFacebook>
        </AnchorCircular>
      </div>

      <div className="component">
        <h2 className="component__title">MenuScreenWhite</h2>
        <MenuScreenWhite className="menu-screen-white--no-fixed">Hola</MenuScreenWhite>
      </div>
      ...
      <div className="component">
        ...
        <SvgStarToFill fill={"75"} inColor="#09feee" outColor="#ffffff"></SvgStarToFill>
      </div>
